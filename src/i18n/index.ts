  ...
  es: {
    ...
    modules: {
      ...
      list: {
        ...
        inventario: { title: "Inventarios", description: "Gestión de diversos inventarios" },
  ...
  en: {
    ...
    modules: {
      ...
      list: {
        ...
        inventario: { title: "Stocktaking", description: "Management of various inventories" },
  ...
  fr: {
    ...
    modules: {
      ...
      list: {
        ...
        inventario: { title: "Stocks", description: "Gestion de divers stocks" },
  ...
  ca: {
    ...
    modules: {
      ...
      list: {
        ...
        inventario: { title: "Inventaris", description: "Gestió de diversos inventaris" },
  ...
  "pt-br": {
    ...
    modules: {
      ...
      list: {
        ...
        inventario: { title: "Estoques", description: "Gestão de diversos estoques" },
