...
date: 2026-05-05
language: "en"
seoKeyword: "modern jewelry management"
featured: true
---
...
**What it solves:** systematize multi-store supply by eliminating simultaneous overstock and stockout.

**What you will learn:**
- **ABC curve** of the catalog applied to jewelry with four crossed criteria (value, sales, units, margin).
- **Needs calculation formula** with its 9 key variables (coverage, target stock, average sales, supply time), with applied numerical example.
- **DRP (Distribution Requirements Planning)** and the difference between push and pull applied to corners and owned stores.
- Three levels of supply maturity: from Excel to integrated ERP.

**Reading:** ~15 minutes.

---

### 2.2 [1998 → 2026: 28 years later, the ERP architecture of a jewelry business is still the same](/blog/arquitectura-erp-joyeria)
...
- The radial flow of the jewelry workshop: cost centers, sections, productive phases, intermediate warehouses.
- The **six modern layers** added since 1998: piece-by-piece traceability, omnichannel, end-customer integration, IoT, predictive analytics, regulatory compliance.
- Three modernized SVG diagrams from original 1998 posters.
...
- The **6 critical variables** the ERP must manage (metal traceability, scrap per phase, real cost per piece, rubber useful life, yield per pour, photographic record).
- The **5 management KPIs** every management should review every week.
- How sustainability goes from optional to commercial argument.
...
**What it solves:** offers an honest comparison between Deming's 14 points (1986) and AI capabilities in 2026, with their successes and risks.

**What you will learn:**
- Point-by-point review of Deming's 14 principles: which remain valid, which have been reformulated, which have been reinforced.
- The **three layers Deming could not foresee**: generative CAD, predictive maintenance, automated compliance.
- **Comparative table** Deming 1986 vs AI 2026 vs what remains human.
- **Real risks** of AI in production: data bias, black box, implementation cost, false sense of security, loss of craft.
...
Not all readers have the same entry point. These are three routes by profile:

### If you are an owner or general management
...
### If you are production or workshop manager
...
## The connecting thread: quality as a system, not as inspection
...
- In **marketing**, quality is brand coherence and segmentation precision, not advertising insistence.
- In **organization**, quality is alignment between structure and strategy, not flashy organizational chart.
- In **logistics**, quality is data-based supply proposal, not manager's intuition.
- In **ERP architecture**, quality is core continuity for decades, not latest fashion technology.
- In **manufacturing**, quality is traceability and control at each phase, not inspection at the end of the process.
- In **AI**, quality is correctly trained model supervised by humans, not blind automation.

---

## How to follow the blog

We publish a strategic analysis every month. New articles extend the series in three directions:

- New management KPIs for jewelry.
...
**Do you share these topics with your management team?** This series is designed to be discussed in committee, not just read alone. Each post has a summary table that works as a starting point for a one-hour conversation.
