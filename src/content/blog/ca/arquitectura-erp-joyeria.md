---
title: "1998 → 2026: 28 anys després, l'arquitectura ERP d'una joieria continua sent la mateixa"
subtitle: "Recuperem dos diagrames de 1998 sobre el flux d'un taller joier integrat. 28 anys després, l'esquema conceptual d'un ERP joier continua intacte: només canvien les capes tecnològiques."
excerpt: "L'arquitectura conceptual d'un ERP joier no ha canviat en 28 anys: només s'hi han apilat capes (traçabilitat, omnicanal, IoT, analítica). Què significa en triar ERP."
date: 2026-05-05
language: ca
translationGroup: "arquitectura-erp-001"
seoTitle: "Arquitectura d'un ERP de joieria | De 1998 a 2026 | RayGold"
seoDescription: "L'arquitectura conceptual d'un ERP joier continua intacta després de 28 anys: només canvien les capes tecnològiques. Què mirar de debò en triar un ERP per a joieria."
seoKeyword: "arquitectura ERP joieria"
seoKeywordsSecondary: "ERP joieria, software gestió joieria, CIM joieria, arquitectura software joier"
category: estrategia
tags: ["CIM", "ERP", "joieria", "arquitectura", "traçabilitat", "IoT", "indústria 4.0"]
ctaType: contacto
ctaUrl: "https://www.raytecno.es/ca/contacte"
readingTime: 12
...
Gairebé tres dècades després, aquesta proposta ha acabat sent l'estàndard de qualsevol ERP joier modern. Però —i això és el que és interessant— **l'esquema conceptual no ha canviat**. El que ha canviat són les **capes tecnològiques** que s'han anat apilant a sobre.
...
Les peces són les mateixes que qualsevol llibre modern d'Indústria 4.0 continua descrivint: administració (comptabilitat, personal, comptabilitat industrial); planificació d'empresa (objectius, estratègia, marc de producció); CAD (disseny, càlcul, dibuix, llista de peces, simulació); CAP (planificació de treball) i CAQ (control de qualitat); PPC (Production Planning and Control: programa de producció, llançament d'ordres); vendes i compres integrats al nucli; i CAM (Computer Aided Manufacturing: control de flux de materials, control de fabricació, conservació).
...
El 1998 una joieria venia a la seva botiga. Punt. Avui una marca joiera mitjana opera en paral·lel a botigues pròpies, córners i espais concessionats en grans superfícies, web pròpia, marketplaces, distribució majorista B2B i esdeveniments efímers (pop-ups, fires).
...
El 1998 el control de fabricació s'alimentava de parts en paper que l'encarregat tecletjava al final del torn. El 2026 les dades vénen directament dels equips: forns de fosa que reporten temperatura i corba del cicle en temps real, bàscules de precisió connectades que registren el pes de cada peça en cada fase, banys de rodi amb control de gruix automatitzat, càmeres que documenten l'estat de la peça en cada punt crític.
...
Els ERP dels 90 contestaven la pregunta *"què va passar?"*. Els ERP moderns contesten també *"què passarà?"*. Aplicat a joieria: predicció de colls d'ampolla (sabent la càrrega actual del taller, quina fase saturarà primer la setmana que ve), predicció de ruptura d'estoc per botiga (combinant històric, estacionalitat i esdeveniments puntuals) i predicció de demanda per col·lecció (detectant abans que la intuïció quines referències s'enlairaran).
...
El 1998 les obligacions normatives eren més senzilles i es gestionaven en paper. El 2026 una joieria s'enfronta a LBMA (certificació d'or responsable), Procés Kimberley (diamants lliures de conflicte), RJC (certificació integral de la cadena), declaracions d'IVA digitals (SII a Espanya i equivalents europeus), registre d'operacions sospitoses (prevenció de blanqueig per a metalls preciosos) i facturació electrònica obligatòria segons evolució regulatòria, com VERI*FACTU.
...
A RayGold ho plantegem exactament així: el nucli és l'arquitectura clàssica del CIM joier, provada durant dècades; les capes modernes (traçabilitat, omnicanal, IoT, analítica, compliment) són mòduls que s'activen segons necessiti cada joieria. Una joieria petita comença pel nucli. Un grup joier amb producció pròpia i vint botigues activa totes les capes.
...
Si la seva joieria té taller propi, xarxa de botigues o ambdues coses, i vol revisar el seu sistema de gestió amb aquesta lent arquitectònica en lloc d'amb una checklist de funcionalitats, [parlem-ne](https://www.raytecno.es/ca/contacte).

---

**Li ha resultat útil aquest article?** Comparteixi'l amb el seu equip directiu.
